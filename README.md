...
| `-cheats`             | Enable cheat dvar modification and cheat command execution. Note: usage when hosting a private match in client or when running dedicated server allows non-host players to execute cheat commands (e.g. `god`, `noclip`) - use at your own risk. |
