...
namespace getinfo {
int get_max_client_count() { return game::get_dvar_int("com_maxclients"); }
...
struct component final : generic_component {
  void post_unpack() override {
    ...
    network::on("getInfo", [](const game::net::netadr_t &target,
      ...
      info.set("hostname", game::get_dvar_string(game::is_server()
