...
namespace ezzsec
{
	...
	// =====================================================================
	using tLobbyMsgRW_PackageInt = BOOL(__fastcall*)(void* lobbyMsg, const char* key, int32_t* val);
	using tLobbyMsgRW_PackageUChar = BOOL(__fastcall*)(void* lobbyMsg, const char* key, char* val);
	using tLobbyMsgRW_PackageString = BOOL(__fastcall*)(void* lobbyMsg, const char* key, const char* val, int maxLength);
	using tLobbyMsgRW_PackageXuid = BOOL(__fastcall*)(void* lobbyMsg, const char* key, uint64_t* val);
	using tLobbyMsgRW_PackageBool = BOOL(__fastcall*)(void* lobbyMsg, const char* key, char* val);
	using tLobbyMsgRW_PackageUInt = BOOL(__fastcall*)(void* lobbyMsg, const char* key, uint32_t* val);
	using tLobbyMsgRW_PackageShort = BOOL(__fastcall*)(void* lobbyMsg, const char* key, int16_t* val);
	using tLobbyMsgRW_PackageUInt64 = BOOL(__fastcall*)(void* lobbyMsg, const char* key, uint64_t* val);
	using tLobbyMsgRW_PackageArrayStart = BOOL(__fastcall*)(void* lobbyMsg, const char* key);
	using tLobbyMsgRW_PackageElement = BOOL(__fastcall*)(void* lobbyMsg, BOOL addElement);
	using tLobbyMsgRW_PackageGlob = BOOL(__fastcall*)(void* lobbyMsg, const char* key, const char* val, int maxLength);
	using tLobbyMsgRW_PackageFloat = BOOL(__fastcall*)(void* lobbyMsg, const char* key, float* val);
	using tMsgMutableClientInfo_Package = BOOL(__fastcall*)(void* outRequest, void* lobbyMsg);
	...
	// boiii-free 0x140000000+x _g = game_base + ((0x140000000+x) - 0x140000000) = game_base + x
	// =====================================================================
	namespace fn
	{
		...
		inline void initialize()
		{
			...
			LobbyMsgRW_PackageInt = reinterpret_cast<tLobbyMsgRW_PackageInt>(0x141EF66D0_g);
			LobbyMsgRW_PackageUChar = reinterpret_cast<tLobbyMsgRW_PackageUChar>(0x141EF6800_g);
			LobbyMsgRW_PackageString = reinterpret_cast<tLobbyMsgRW_PackageString>(0x141EF6770_g);
			LobbyMsgRW_PackageXuid = reinterpret_cast<tLobbyMsgRW_PackageXuid>(0x141EF6940_g);
			LobbyMsgRW_PackageBool = reinterpret_cast<tLobbyMsgRW_PackageBool>(0x141EF6580_g);
			LobbyMsgRW_PackageUInt = reinterpret_cast<tLobbyMsgRW_PackageUInt>(0x141EF68A0_g);
			LobbyMsgRW_PackageShort = reinterpret_cast<tLobbyMsgRW_PackageShort>(0x141EF6750_g);
			LobbyMsgRW_PackageUInt64 = reinterpret_cast<tLobbyMsgRW_PackageUInt64>(0x141EF6820_g);
			LobbyMsgRW_PackageArrayStart = reinterpret_cast<tLobbyMsgRW_PackageArrayStart>(0x141EF6510_g);
			LobbyMsgRW_PackageElement = reinterpret_cast<tLobbyMsgRW_PackageElement>(0x141EF65C0_g);
			LobbyMsgRW_PackageGlob = reinterpret_cast<tLobbyMsgRW_PackageGlob>(0x141EF66B0_g);
			LobbyMsgRW_PackageFloat = reinterpret_cast<tLobbyMsgRW_PackageFloat>(0x141EF6630_g);
			MsgMutableClientInfo_Package = reinterpret_cast<tMsgMutableClientInfo_Package>(0x141ED47D0_g);
			LobbyMsgRW_PrepReadData = reinterpret_cast<tLobbyMsgRW_PrepReadData>(0x141EF69C0_g);
	...
	{
		BOOL packageOK =
			fn::LobbyMsgRW_PackageInt(lobbyMsg, "targetlobby", reinterpret_cast<int32_t*>(_this))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "sourcelobby", reinterpret_cast<int32_t*>(_this + 4))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "jointype", reinterpret_cast<int32_t*>(_this + 8))
			&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "probedxuid", reinterpret_cast<uint64_t*>(_this + 16))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "playlistid", reinterpret_cast<int32_t*>(_this + 612))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "playlistver", reinterpret_cast<int32_t*>(_this + 616))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "ffotdver", reinterpret_cast<int32_t*>(_this + 620))
			&& fn::LobbyMsgRW_PackageShort(lobbyMsg, "networkmode", reinterpret_cast<int16_t*>(_this + 624))
			&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "netchecksum", reinterpret_cast<uint32_t*>(_this + 628))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "protocol", reinterpret_cast<int32_t*>(_this + 632))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "changelist", reinterpret_cast<int32_t*>(_this + 636))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "pingband", reinterpret_cast<int32_t*>(_this + 640))
			&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "dlcbits", reinterpret_cast<uint32_t*>(_this + 644))
			&& fn::LobbyMsgRW_PackageUInt64(lobbyMsg, "joinnonce", reinterpret_cast<uint64_t*>(_this + 648));

		for (int i = 0; packageOK && (i < 3); i++)
		{
			packageOK = packageOK && fn::LobbyMsgRW_PackageUChar(lobbyMsg, "chunk", _this + i + 689);
		}

		packageOK = packageOK &&
			fn::LobbyMsgRW_PackageBool(lobbyMsg, "isStarterPack", _this + 656)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "password", _this + 657, 0x20)
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "membercount", reinterpret_cast<int32_t*>(_this + 24))
		...
		if (fn::LobbyMsgRW_PackageElement(lobbyMsg, *reinterpret_cast<int32_t*>(_this + 24) > 0))
		{
			...
			{
				packageOK = packageOK
					&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "xuid", reinterpret_cast<uint64_t*>(_this + 616))
					&& fn::LobbyMsgRW_PackageUInt64(lobbyMsg, "lobbyid", reinterpret_cast<uint64_t*>(_this + 616))
					&& fn::LobbyMsgRW_PackageFloat(lobbyMsg, "skillrating", reinterpret_cast<float*>(_this + 616))
					&& fn::LobbyMsgRW_PackageFloat(lobbyMsg, "skillvariance", reinterpret_cast<float*>(_this + 616))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "pprobation", reinterpret_cast<uint32_t*>(_this + 616))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "aprobation", reinterpret_cast<uint32_t*>(_this + 616));
	...
	inline int MSG_LobbyState_Package_Inspect(char* __this, char* lobbyMsg)
	{
		...
		BOOL packageOK =
			...
			&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "leaderactivity", reinterpret_cast<char*>(_this) + 32)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "key", reinterpret_cast<char*>(_this + 9), 0x20)
			&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "leader", reinterpret_cast<uint64_t*>(_this + 9))
			&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "platformsession", reinterpret_cast<uint64_t*>(_this + 10))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "maxclients", _this + 22)
			&& fn::LobbyMsgRW_PackageBool(lobbyMsg, "isadvertised", reinterpret_cast<char*>(_this) + 92)
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "clientcount", _this + 24)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "sessionid", reinterpret_cast<char*>(_this + 5320), 0x40)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "sessioninfo", reinterpret_cast<char*>(_this + 5336), 0x40)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "ugcName", reinterpret_cast<char*>(_this + 5352), 0x20)
			&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "ugcVersion", reinterpret_cast<uint32_t*>(_this + 5360));
		...
		int index = 0;
		bool hasNextElement = fn::LobbyMsgRW_PackageElement(lobbyMsg, index < _this[24]);
		...
		while (hasNextElement && index < _this[24])
		{
			...
			packageOK = packageOK
				&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "xuid", reinterpret_cast<uint64_t*>(offset2))
				&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "clientNum", reinterpret_cast<char*>(offset2 + 8))
				&& fn::LobbyMsgRW_PackageString(lobbyMsg, "gamertag", reinterpret_cast<char*>(offset2 + 9), 0x20)
				&& fn::LobbyMsgRW_PackageBool(lobbyMsg, "isGuest", reinterpret_cast<char*>(offset2 + 41))
				&& fn::LobbyMsgRW_PackageUInt64(lobbyMsg, "lobbyid", reinterpret_cast<uint64_t*>(offset2 + 48))
				&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "connectbit", reinterpret_cast<int32_t*>(offset2 + 1108))
				&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "score", reinterpret_cast<int32_t*>(offset2 + 1104))
				&& fn::LobbyMsgRW_PackageGlob(lobbyMsg, "address", reinterpret_cast<char*>(offset2 + 1113), 37)
				&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "qport", reinterpret_cast<int32_t*>(offset2 + 56))
				&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "band", reinterpret_cast<char*>(offset2 + 60))
				&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "netsrc", reinterpret_cast<uint32_t*>(offset2 + 1152))
				&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "joinorder", reinterpret_cast<uint32_t*>(offset2 + 1156))
				&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "dlcBits", reinterpret_cast<uint32_t*>(offset2 + 1160))
				&& fn::MsgMutableClientInfo_Package(reinterpret_cast<char*>(offset2 + 64), lobbyMsg);
		...
		packageOK = packageOK
			&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "migratebits", reinterpret_cast<char*>(_this) + 21128)
		...
		{
			packageOK = packageOK && fn::LobbyMsgRW_PackageXuid(lobbyMsg, "xuid", reinterpret_cast<uint64_t*>(&_this[0x14A4 + (2 * count)]));
			count++;
	...
	inline int MSG_LobbyStateGame_Package_Inspect(char* __this, char* lobbyMsg)
	{
		...
		int32_t* _this = reinterpret_cast<int32_t*>(__this);
		bool packageOK = fn::LobbyMsgRW_PackageInt(lobbyMsg, "serverstatus", _this + 5362);
		...
		packageOK = packageOK
			...
			&& fn::LobbyMsgRW_PackageUInt64(lobbyMsg, "matchhashlow", reinterpret_cast<uint64_t*>(_this + 2682))
			&& fn::LobbyMsgRW_PackageUInt64(lobbyMsg, "matchhashhigh", reinterpret_cast<uint64_t*>(_this + 2683))
			...
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "gametype", reinterpret_cast<char*>(_this + 5369), 0x20)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "map", reinterpret_cast<char*>(_this + 5377), 0x20)
			&& fn::LobbyMsgRW_PackageString(lobbyMsg, "ugcName", reinterpret_cast<char*>(_this + 5385), 0x20)
			&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "ugcVersion", reinterpret_cast<uint32_t*>(_this + 5393));

		if (!_this[2])
		{
			packageOK = packageOK
				&& fn::LobbyMsgRW_PackageString(lobbyMsg, "cpqueuedlevel", reinterpret_cast<char*>(_this + 7293), 0x20)
				&& fn::LobbyMsgRW_PackageBool(lobbyMsg, "movieskipped", reinterpret_cast<char*>(_this) + 29204);
		}
		...
		if (!lobbyMode) // LOBBY_MODE_PUBLIC
		{
			...
			while (hasNextElement && (index < 18))
			{
				...
				packageOK = packageOK
					&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "team", reinterpret_cast<int32_t*>(currentClient + 28524))
					&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "mapvote", reinterpret_cast<int32_t*>(currentClient + 28528))
					&& fn::LobbyMsgRW_PackageBool(lobbyMsg, "readyup", reinterpret_cast<char*>(currentClient + 28532));
			...
			packageOK = packageOK
				...
				&& fn::LobbyMsgRW_PackageGlob(lobbyMsg, "plistentries", reinterpret_cast<char*>(_this) + 28512, 8)
				&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "plistnext", reinterpret_cast<char*>(_this) + 28520)
				&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "plistprev", reinterpret_cast<char*>(_this) + 28521)
				&& fn::LobbyMsgRW_PackageUChar(lobbyMsg, "plistprevcount", reinterpret_cast<char*>(_this) + 28522);
		...
		{
			packageOK = packageOK && fn::LobbyMsgRW_PackageInt(lobbyMsg, "votecount", _this + 5397);
			...
			int index = 0;
			bool hasNextElement = fn::LobbyMsgRW_PackageElement(lobbyMsg, index < numVotes);

			while (hasNextElement && (index < numVotes))
			{
				int64_t currentVote = reinterpret_cast<int64_t>(&_this[8 * index + 5398]);
				packageOK = packageOK
					&& fn::LobbyMsgRW_PackageShort(lobbyMsg, "itemtype", reinterpret_cast<int16_t*>(currentVote + 8))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "item", reinterpret_cast<uint32_t*>(currentVote + 12))
					&& fn::LobbyMsgRW_PackageShort(lobbyMsg, "itemgroup", reinterpret_cast<int16_t*>(currentVote + 16))
					&& fn::LobbyMsgRW_PackageShort(lobbyMsg, "attachment", reinterpret_cast<int16_t*>(currentVote + 20))
					&& fn::LobbyMsgRW_PackageShort(lobbyMsg, "votetype", reinterpret_cast<int16_t*>(currentVote + 24))
					&& fn::LobbyMsgRW_PackageXuid(lobbyMsg, "votexuid", reinterpret_cast<uint64_t*>(currentVote));
				...
				index++;
				hasNextElement = fn::LobbyMsgRW_PackageElement(lobbyMsg, index < numVotes);
			}
			...
			while (hasNextElement && (index < 18))
			{
				int64_t currentClient = reinterpret_cast<int64_t>(&_this[index + 8 * index + 7131]);
				packageOK = packageOK
					&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "team", reinterpret_cast<int32_t*>(currentClient))
					&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "pregamepos", reinterpret_cast<int32_t*>(currentClient + 4))
					&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "pregamestate", reinterpret_cast<int32_t*>(currentClient + 3))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "clvotecount", reinterpret_cast<uint32_t*>(currentClient + 6))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "character", reinterpret_cast<uint32_t*>(currentClient + 7))
					&& fn::LobbyMsgRW_PackageUInt(lobbyMsg, "loadout", reinterpret_cast<uint32_t*>(currentClient + 8));
			...
			packageOK = packageOK && fn::LobbyMsgRW_PackageInt(lobbyMsg, "settingssize", _this + 7350);
	...
	inline int MSG_InfoResponse_Inspect(char* __this, char* lobbyMsg)
	{
		...
		for (int32_t cResponse = 0; hasNextElement && (cResponse < 2); cResponse++)
		{
			...
			{
				char isValid = 0;
				packIsOK = packIsOK && fn::LobbyMsgRW_PackageBool(lobbyMsg, "valid", &isValid);
				if (!packIsOK)
					return 2;
	...
	{
		bool packageOK = fn::LobbyMsgRW_PackageInt(lobbyMsg, "heartbeatnum", reinterpret_cast<int32_t*>(__this))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "lobbytype", reinterpret_cast<int32_t*>(__this))
			&& fn::LobbyMsgRW_PackageInt(lobbyMsg, "lasthosttimems", reinterpret_cast<int32_t*>(__this));
		...
		{
			packageOK = packageOK && fn::LobbyMsgRW_PackageXuid(lobbyMsg, "xuid", reinterpret_cast<uint64_t*>(__this));
			count++;
	...
	using packet_callback_t = std::function<void(int32_t* lobbyMsgTypePtr, char* lobbyMsg)>;
	...
	inline std::unordered_map<uint8_t, packet_callback_t>& get_packet_callbacks()
	{
		...
		if (!registered)
		{
			...
			callbacks[0xF] = [](int32_t* lobbyMsgTypePtr, [[maybe_unused]] char* lobbyMsg)
			{
			...
			callbacks[0x1E] = callbacks[0xF]; // MESSAGE_TYPE_VOICE_PACKET (voice crash exploit)
			...
			callbacks[MESSAGE_TYPE_LOBBY_HOST_HEARTBEAT] = [](int32_t* lobbyMsgTypePtr, char* lobbyMsg)
			{
				...
				{
					*lobbyMsgTypePtr = 0xFF;
					printf("[Security] Dropped malicious HostHeartbeat packet (reason: %d)\n", result);
				}
			};
			...
			callbacks[0x3] = [](int32_t* lobbyMsgTypePtr, char* lobbyMsg)
			{
				...
				{
					*lobbyMsgTypePtr = 0xFF;
					printf("[Security] Dropped malicious LobbyStateGame packet (reason: %d)\n", result);
				}
			};
			...
			callbacks[0x1] = [](int32_t* lobbyMsgTypePtr, char* lobbyMsg)
			{
				...
				{
					*lobbyMsgTypePtr = 0xFF;
					printf("[Security] Dropped malicious InfoResponse packet (reason: %d)\n", result);
				}
			};
	...
	inline bool InspectPacket(game::msg_t* msg)
	{
		...
		const uint32_t remaining = static_cast<uint32_t>(msg->cursize - msg->readcount);
		...
		char data[0x2000]{};
		const uint32_t readSize = (remaining < sizeof(data)) ? remaining : static_cast<uint32_t>(sizeof(data));
		...
		LobbyMsg lobbyMsg{};
		if (!fn::LobbyMsgRW_PrepReadData(&lobbyMsg, data, static_cast<int>(readSize)))
		{
