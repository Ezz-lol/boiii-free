...
public:
  ...
  GetWindowContext(LPOLEINPLACEFRAME *lplpFrame, LPOLEINPLACEUIWINDOW *lplpDoc,
    ...
    if (FAILED(
            QueryInterface(IID_IOleInPlaceFrame,
                           reinterpret_cast<void **>(&ole_in_place_frame)))) {
      *lplpFrame = nullptr;
      *lplpDoc = nullptr;
      return E_FAIL;
    }
