...
namespace {
script_value get_field(void *ptr, game::hks::HksObjectType type,
...
void set_field(void *ptr, game::hks::HksObjectType type,
...
arguments call_script_function(const function &function,
  ...
  game::hks::vm_call_internal(state, static_cast<int>(arguments.size()), -1,
                              nullptr);
