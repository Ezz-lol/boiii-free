...
private:
  ...
  void getPublicMemberProfiles(service_server *server,
                               byte_buffer *buffer) const;
  void getPrivateMemberProfiles(service_server *server,
                                byte_buffer *buffer) const;
  ...
  void setPublicMemberProfile(service_server *server,
                              byte_buffer *buffer) const;
  void setPrivateMemberProfile(service_server *server,
                               byte_buffer *buffer) const;
  ...
  void sendInstantMessageToTeam(service_server *server,
                                byte_buffer *buffer) const;
  void searchPublicTeamProfiles(service_server *server,
                                byte_buffer *buffer) const;
  ...
  void createTeamWithProfiles(service_server *server,
                              byte_buffer *buffer) const;
  ...
  void getMembershipsWithCounts(service_server *server,
                                byte_buffer *buffer) const;
  void getMembershipsWithCountsUser(service_server *server,
                                    byte_buffer *buffer) const;
  void searchTeams(service_server *server, byte_buffer *buffer) const;
  void createTeamWithProfilesAndTeamType(service_server *server,
                                         byte_buffer *buffer) const;
  void getMembershipsWithCountsAndTeamTypeUser(service_server *server,
                                               byte_buffer *buffer) const;
  void getMembershipsWithCountsAndTeamType(service_server *server,
                                           byte_buffer *buffer) const;
  void getTeamInfoWithTeamType(service_server *server,
                               byte_buffer *buffer) const;
  ...
  void getMembersAndPrivileges(service_server *server,
                               byte_buffer *buffer) const;
};
} // namespace demonware
