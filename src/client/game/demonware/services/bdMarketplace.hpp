...
private:
  void startExchangeTransaction(service_server *server,
                                byte_buffer *buffer) const;
  void purchaseOnSteamInitialize(service_server *server,
                                 byte_buffer *buffer) const;
  void getExpiredInventoryItems(service_server *server,
                                byte_buffer *buffer) const;
  ...
  void putPlayersInventoryItems(service_server *server,
                                byte_buffer *buffer) const;
  void getEntitlements(service_server *server, byte_buffer *buffer) const;
  void getMarketplaceInventory(service_server *server,
                               byte_buffer *buffer) const;
  void validateMarketplaceTransaction(service_server *server,
                                      byte_buffer *buffer) const;
};
} // namespace demonware
