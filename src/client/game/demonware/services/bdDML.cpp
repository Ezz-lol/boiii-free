...
void bdDML::getUserData(service_server *server,
...
void bdDML::getUserHierarchicalData(service_server *server,
                                    byte_buffer * /*buffer*/) const {
  // TODO:
  auto reply = server->create_reply(this->task_id());
  reply.send();
...
void bdDML::getUsersLastLogonData(service_server *server,
                                  byte_buffer * /*buffer*/) const {
  // TODO:
  auto reply = server->create_reply(this->task_id());
  reply.send();
