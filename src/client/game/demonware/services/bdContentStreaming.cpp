...
void bdContentStreaming::unk2(service_server *server,
...
void bdContentStreaming::list_all_publisher_files(service_server *server,
                                                  byte_buffer *buffer) const {
  ...
  game::dw::bdLobbyErrorCode::NO_FILE).send(); return;
  }*/
