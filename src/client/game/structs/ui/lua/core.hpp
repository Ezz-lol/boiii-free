...
enum class StorageFileType : int32_t {
  ...
  STORAGE_CP_SAVEGAME_ONLINE = 2,
  STORAGE_CP_SAVEGAME_OFFLINE = 3,
  STORAGE_CPNIGHTMARE_SAVEGAME_ONLINE = 4,
  STORAGE_CPNIGHTMARE_SAVEGAME_OFFLINE = 5,
  STORAGE_CP_STATS_ONLINE = 6,
  STORAGE_CP_STATS_OFFLINE = 7,
  STORAGE_CP_STATS_NIGHTMARE_ONLINE = 8,
  STORAGE_CP_STATS_NIGHTMARE_OFFLINE = 9,
  STORAGE_CP_LOADOUTS = 10,
  STORAGE_CP_LOADOUTS_OFFLINE = 11,
  STORAGE_MP_STATS_ONLINE = 12,
  STORAGE_MP_STATS_OFFLINE = 13,
  STORAGE_MP_LOADOUTS = 14,
  STORAGE_MP_LOADOUTS_OFFLINE = 15,
  STORAGE_MP_CLASS_SETS = 16,
  STORAGE_ZM_STATS_ONLINE = 17,
  STORAGE_ZM_STATS_OFFLINE = 18,
  STORAGE_ZM_LOADOUTS = 19,
  STORAGE_ZM_LOADOUTS_OFFLINE = 20,
  STORAGE_FR_STATS_ONLINE = 21,
  STORAGE_FR_STATS_OFFLINE = 22,
  STORAGE_PAINTSHOP_DATA = 23,
  STORAGE_GUNSMITH = 24,
  STORAGE_PAINTJOBS = 25,
  STORAGE_EMBLEMS = 26,
  STORAGE_DEFAULT_EMBLEMS = 27,
  STORAGE_EMBLEMS_LOOT = 28,
  STORAGE_CUSTOM_GAMES = 29,
  STORAGE_OFFICIAL_CUSTOM_GAMES = 30,
  STORAGE_EXTERNAL_DATA = 31,
  STORAGE_FILE_COUNT = 32,
