...
enum class CriticalSection : int32_t {
  ...
  CRITSECT_CLIENT_MESSAGE = 0x22,
  CRITSECT_CLIENT_CMD = 0x23,
  CRITSECT_DOBJ_ALLOC = 0x24,
  CRITSECT_XANIM_ALLOC = 0x25,
  CRITSECT_KEY_BINDINGS = 0x26,
  CRITSECT_SERVER_MESSAGE = 0x27,
  CRITSECT_SERVER_PLAYERINFO = 0x28,
  CRITSECT_SERVER_TICK = 0x29,
  CRITSECT_SCRIPT_STRING = 0x2A,
  CRITSECT_MEMORY_TREE = 0x2B,
  CRITSECT_SCRIPT_DEBUGGER = 0x2C,
  CRITSECT_VM = 0x2D,
  CRITSECT_THREADED_NOTIFY_QUEUE = 0x2E,
  CRITSECT_LIVE = 0x2F,
  CRITSECT_PCACHE = 0x30,
  CRITSECT_AUDIO_PHYSICS = 0x31,
  CRITSECT_LUA = 0x32,
  CRITSECT_LUI = 0x33,
  CRITSECT_LOBBY_LUA = 0x34,
  CRITSECT_EXTRACAM = 0x35,
  CRITSECT_CINEMATIC = 0x36,
  CRITSECT_CINEMATIC_MP4 = 0x37,
  CRITSECT_CINEMATIC_UPDATEFRAME = 0x38,
  CRITSECT_SAVE_PROFILE = 0x39,
  CRITSECT_MEM_CONTAINER_SAVEGAME = 0x3A,
  CRITSECT_VIRTUALALLOC = 0x3B,
  CRITSECT_RB_TRANSFER = 0x3C,
  CRITSECT_STREAM_SYNC_COMMAND = 0x3D,
  CRITSECT_STREAM_FIXEDIMAGE_UPDATE = 0x3E,
  CRITSECT_STREAM_MODELHINT_UPDATE = 0x3F,
  CRITSECT_DWLSG = 0x40,
  CRITSECT_DWNET = 0x41,
  CRITSECT_IK = 0x42,
  CRITSECT_TL_MEMALLOC = 0x43,
  CRITSECT_VA_ALLOC = 0x44,
  CRITSECT_MEMTRACK = 0x45,
  CRITSECT_CBUF = 0x46,
  CRITSECT_CURVEALLOC = 0x47,
  CRITSECT_NETQUEUE = 0x48,
  CRITSECT_ZLIB = 0x49,
  CRITSECT_BLACKBOX = 0x4A,
  CRITSECT_GDT_COMMAND = 0x4B,
  CRITSECT_STRINGED_COMMAND = 0x4C,
  CRITSECT_RADIANT_SERVER_COMMAND = 0x4D,
  CRITSECT_RADIANT_CLIENT_COMMAND = 0x4E,
  CRITSECT_RECORDER = 0x4F,
  CRITSECT_SERVERDEMO = 0x50,
  CRITSECT_IO_SCHEDULER = 0x51,
  CRITSECT_FILE_ID_ARRAY = 0x52,
  CRITSECT_MEMFIRSTFIT = 0x53,
  CRITSECT_FXBEAM = 0x54,
  CRITSECT_GLASS_ACTIONS = 0x55,
  CRITSECT_DBHASH = 0x56,
  CRITSECT_CLUMP = 0x57,
  CRITSECT_SNAPSHOT_PROFILE = 0x58,
  CRITSEC_WEBM_STREAM_ACCESS = 0x59,
  CRITSEC_SV_LEADERBOARDS = 0x5A,
  CRITSECT_FONT_CACHE = 0x5B,
  CRITSEC_NETCHAN = 0x5C,
  CRITSECT_SWITCHMAP_SV = 0x5D,
  CRITSECT_SWITCHMAP_CL = 0x5E,
  CRITSECT_DB_THROTTLE_DECOMPRESSION = 0x5F,
  CRITSECT_PROFILE_BUF = 0x60,
  CRITSECT_SAVE_DEVICE = 0x61,
  CRITSECT_WATER_INTERACTION = 0x62,
  CRITSECT_WATER_GRID_ALLOC = 0x63,
  CRITSECT_WATER_NODE_ALLOC = 0x64,
  CRITSECT_MEM_PAGED = 0x65,
  CRITSECT_ENTITY_COLL_LINK = 0x66,
  CRITSECT_MINIZ = 0x67,
  CRITSECT_COMPOSITING = 0x68,
  CRITSECT_CREATE_DYNENT = 0x69,
  CRITSECT_LENSFLARES_INSTANCE_POOL_ACCESS0 = 0x6A,
  CRITSECT_LENSFLARES_INSTANCE_POOL_ACCESS1 = 0x6B,
  CRITSECT_LENSFLARES_INSTANCE_POOL_ACCESS2 = 0x6C,
  CRITSECT_LENSFLARES_INSTANCE_POOL_ACCESS3 = 0x6D,
  CRITSECT_LENSFLARES_INSTANCE_POOL_ACCESS4 = 0x6E,
  CRITSECT_LENSFLARES_ACTIVE_INSTANCES_ACCESS0 = 0x6F,
  CRITSECT_LENSFLARES_ACTIVE_INSTANCES_ACCESS1 = 0x70,
  CRITSECT_LENSFLARES_ACTIVE_INSTANCES_ACCESS2 = 0x71,
  CRITSECT_LENSFLARES_ACTIVE_INSTANCES_ACCESS3 = 0x72,
  CRITSECT_LENSFLARES_ACTIVE_INSTANCES_ACCESS4 = 0x73,
  CRITSECT_LENSFLARES_SOURCE_ACCESS0 = 0x74,
  CRITSECT_LENSFLARES_SOURCE_ACCESS1 = 0x75,
  CRITSECT_LENSFLARES_SOURCE_ACCESS2 = 0x76,
  CRITSECT_LENSFLARES_SOURCE_ACCESS3 = 0x77,
  CRITSECT_LENSFLARES_SOURCE_ACCESS4 = 0x78,
  CRITSECT_COMSCORE = 0x79,
  CRITSECT_WEAPON_DOBJ_INFO_ALLOC = 0x7A,
  CRITSECT_LIVE_ALLOC = 0x7B,
  CRITSECT_UMBRA_SPOTOMNI_CACHE = 0x7C,
  CRITSECT_UMBRA_JOB = 0x7D,
  CRITSECT_COUNT = 0x7E,
};
