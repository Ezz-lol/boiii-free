...
struct cgZBarrierPiece {
  ...
  centity_t *pPiece;
  db::xasset::xmodel::XModel *curXModel;
...
struct Character {
  ...
  db::xasset::xmodel::XModelPtr body;
  db::xasset::xmodel::XModelAliasPtr bodyAlias;
  db::xasset::xmodel::XModelPtr head;
  db::xasset::xmodel::XModelAliasPtr headAlias;
  db::xasset::xmodel::XModelAliasPtr headAliasZombie;
  db::xasset::xmodel::XModelPtr hat;
  db::xasset::xmodel::XModelAliasPtr hatAlias;
  db::xasset::xmodel::XModelPtr gear;
  db::xasset::xmodel::XModelAliasPtr gearAlias;
  db::xasset::xmodel::XModelPtr viewModel;
  db::xasset::xmodel::XModelPtr shadowCharacter;
  db::xasset::xmodel::XModelPtr damagedTorso_Clean;
  db::xasset::xmodel::XModelAliasPtr damagedTorso_Clean_Alias;
  db::xasset::xmodel::XModelPtr damagedTorso_RightArmGone;
  db::xasset::xmodel::XModelAliasPtr damagedTorso_RightArmGone_Alias;
  db::xasset::xmodel::XModelPtr damagedTorso_LeftArmGone;
  db::xasset::xmodel::XModelAliasPtr damagedTorso_LeftArmGone_Alias;
  db::xasset::xmodel::XModelPtr damagedTorso_GutsGone;
  db::xasset::xmodel::XModelAliasPtr damagedTorso_GutsGone_Alias;
  db::xasset::xmodel::XModelPtr damagedTorso_HeadGone;
  db::xasset::xmodel::XModelAliasPtr damagedTorso_HeadGone_Alias;
  db::xasset::xmodel::XModelPtr damagedLegs_Clean;
  db::xasset::xmodel::XModelAliasPtr damagedLegs_Clean_Alias;
  db::xasset::xmodel::XModelPtr damagedLegs_RightLegGone;
  db::xasset::xmodel::XModelAliasPtr damagedLegs_RightLegGone_Alias;
  db::xasset::xmodel::XModelPtr damagedLegs_LeftLegGone;
  db::xasset::xmodel::XModelAliasPtr damagedLegs_LeftLegGone_Alias;
  db::xasset::xmodel::XModelPtr damagedLegs_NoLegs;
  db::xasset::xmodel::XModelAliasPtr damagedLegs_NoLegs_Alias;
  db::xasset::xmodel::XModelPtr chestGear_Right;
  bool chestGear_Right_Required;
  db::xasset::xmodel::XModelPtr chestGear_Left;
  bool chestGear_Left_Required;
  db::xasset::xmodel::XModelPtr frontPack;
  bool frontPack_Required;
  db::xasset::xmodel::XModelPtr frontPackLow;
  bool frontPackLow_Required;
  db::xasset::xmodel::XModelPtr backPack;
  bool backPack_Required;
  db::xasset::xmodel::XModelPtr rearGear_Right;
  bool rearGear_Right_Required;
  db::xasset::xmodel::XModelPtr rearGear_Left;
  bool rearGear_Left_Required;
  db::xasset::xmodel::XModelPtr rearGearSide_Right;
  bool rearGearSide_Right_Required;
  db::xasset::xmodel::XModelPtr rearGearSide_Left;
  bool rearGearSide_Left_Required;
  db::xasset::xmodel::XModelPtr sideGear_Right;
  bool sideGear_Right_Required;
  db::xasset::xmodel::XModelPtr sideGear_Left;
  bool sideGear_Left_Required;
  db::xasset::xmodel::XModelPtr frontGear_Right;
  bool frontGear_Right_Required;
  db::xasset::xmodel::XModelPtr frontGear_Left;
  bool frontGear_Left_Required;
  db::xasset::xmodel::XModelPtr helmet;
  bool helmet_Required;
  db::xasset::xmodel::XModelPtr misc1;
  bool misc1_Required;
  db::xasset::xmodel::XModelPtr misc2;
  bool misc2_Required;
  db::xasset::xmodel::XModelPtr misc3;
  bool misc3_Required;
...
struct bgs_t {
  ...
  db::xasset::xmodel::XModel *(*GetXModel)(const char *);
...
partial_def(CG_T_SIZE, struct __attribute__((aligned(16))), cg_t, {
  ...
  // CentityPool<db::xasset::xmodel::XModel *> pEntityLastXModel;
