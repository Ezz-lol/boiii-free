...
typedef fastcall_t<void, LocalClientNum_t, cg_t *, centity_t *, ZBarrierDef *,
                   cgZBarrierPiece *, LerpEntityStateZBarrierPiece *, uint32_t>
...
struct centity_t {
  ...
  uint8_t deployedRiotshieldHits[8];
  ...
  union {
    ...
    struct {
      ...
      uint64_t bMuzzleFlash : 1;
      uint64_t bMuzzleFlashLeft : 1;
      uint64_t bMuzzleFlashLastShot : 1;
      uint64_t bShellEject : 1;
      uint64_t bShellEjectLeft : 1;
      uint64_t bStartedEffects : 1;
      uint64_t bPlayedWhizby : 1;
      uint64_t skipBloodImpacts : 1;
      uint64_t heroBloodImpact : 1;
      uint64_t scriptThreaded : 1;
      uint64_t didOverheatFx : 1;
      uint64_t leftFootstep : 1;
      uint64_t rightFootstep : 1;
      uint64_t leftRearFootstep : 1;
      uint64_t rightRearFootstep : 1;
      uint64_t bIsOneShot : 1;
      uint64_t bEntityOnRadar : 1;
      uint64_t bFloatLonger : 1;
      uint64_t bForceBuoyancy : 1;
      uint64_t bRenderedLastFrame : 1;
      uint64_t bIgnoreRagdoll : 1;
      uint64_t bUpdatedSinceReset : 1;
      uint64_t bUpdateToggle : 1;
      uint64_t bZombieEyeGlowHasBeenTurnedOn : 1;
      uint64_t bIsOnRadar : 1;
      uint64_t bAllowPitchAngle : 1;
      uint64_t bFakeEntityMoving : 1;
      uint64_t bFakeEntityTurning : 1;
      uint64_t bFakeEntityRemoved : 1;
      uint64_t partOfZBarrier : 1;
      uint64_t linkRelativeAngles : 1;
      uint64_t sndTurretWasFiring : 1;
      uint64_t clientMainThreaded : 1;
      uint64_t renderInThirdPersonSpectate : 1;
      uint64_t forceNotSimple : 1;
      uint64_t bForceNameVisible : 2;
      uint64_t bWaterDisturbance : 1;
      uint64_t bIsHiddenOnClient : 1;
      uint64_t bNotifyOnBulletImpact : 1;
      uint64_t bFakeAi : 1;
      uint64_t bHideWhenAnimationEnds : 1;
      uint64_t bAimTargetVisible : 1;
      uint64_t bAimTargetMeleeClearance : 1;
      uint64_t doNotDelayNotetrackEvents : 1;
      uint64_t bHiddenFromRadarOutsideVisionCircle : 1;
    };
  };
};
...
enum class scoreboardColumnType_t : uint32_t {
  INVALID = 0x0,
  NONE = 0x1,
  SCORE = 0x2,
  KILLS = 0x3,
