...
#define Com_Error(code, fmt, ...) Com_Error_(__FILE__, __LINE__, code, fmt, ##__VA_ARGS__)
	...
	// LiveStats
	WEAK symbol<const char*(int controllerIndex)> LiveStats_GetClanTagText{0x141E9CE20};
	...
	WEAK symbol<bool(const char*, netadr_t*)> NET_StringToAdr{0x142172780, 0x140515110};
	...
	WEAK symbol<float (const dvar_t* dvar)> Dvar_GetDomainFloatMax{
		0x1422BD3C0, 0x140575940
	};
	WEAK symbol<float (const dvar_t* dvar)> Dvar_GetDomainFloatMin{
		0x1422BD400, 0x140575980
	};
	WEAK symbol<int64_t (const dvar_t* dvar)> Dvar_GetDomainInt64Max{
		0x1422BD440, 0x140575A90
	};
	WEAK symbol<int64_t (const dvar_t* dvar)> Dvar_GetDomainInt64Min{
		0x1422BD480, 0x1405759C0
	};
	WEAK symbol<int32_t (const dvar_t* dvar)> Dvar_GetDomainIntMax{
		0x1422BD4C0, 0x140575A00
	};
	WEAK symbol<int32_t (const dvar_t* dvar)> Dvar_GetDomainIntMin{
		0x1422BD510, 0x140575A50
	};

	WEAK symbol<float (const dvar_t* dvar)> Dvar_GetFloat{0x1422BD620, 0x140575B20};
	WEAK symbol<int64_t (const dvar_t* dvar)> Dvar_GetInt64{0x1422BDC50, 0x140575B90};
	...
	WEAK symbol<void (const dvar_t* dvar, bool val, DvarSetSource source)> Dvar_SetBoolFromSource{
		0x1422C6290, 0x140578BA0
	};
	WEAK symbol<void (const dvar_t* dvar, float val, DvarSetSource source)> Dvar_SetFloatFromSource{
		0x1422C6DD0, 0x140579190
	};
	WEAK symbol<void (const dvar_t* dvar, int64_t val, DvarSetSource source)> Dvar_SetInt64FromSource{
		0x1422C7B70, 0x140579660
	};
	WEAK symbol<void (const dvar_t* dvar, int32_t val, DvarSetSource source)> Dvar_SetIntFromSource{
		0x1422C7ED0, 0x140579740
	};
	WEAK symbol<void (const dvar_t* dvar, uint64_t val, DvarSetSource source)> Dvar_SetUInt64FromSource{
		0x1422C8AF0, 0x140579B60
	};
