...
WEAK symbol<void(hks::lua_State *, const char *)> Lua_CoD_LoadLuaFile{
    0x141F052A0, 0x141F11A20, 0x1404BE1C0};

WEAK symbol<game::db::xasset::XAssetHeader(const char *filename)>
    Lua_CoD_GetRawFile{0x141F02860, 0x141F0EFE0, 0x1404BCB70};
...
WEAK symbol<hks::lua_State *(hks::luaState_e luaState, void *memoryLocation,
    ...
    Lua_CoD_GenerateLuaState{0x141F05030, 0x141F117B0, 0x1404BE010};
...
WEAK symbol<hks::lua_State *(hks::luaState_e luaState,
    ...
    Lua_CoD_GenerateLuaState_Internal{0x141F04E50, 0x141F115D0, 0x1404BDE40};
WEAK symbol<hks::lua_Reader> Lua_CoD_FFReader{0x141F027E0, 0x141F0EF60,
                                              0x1404BCAF0};
WEAK symbol<CodLuaStates> s_codLuaStates{0x1433910B0, 0x1434100A0, 0x141122FB0};
} // namespace cod
} // namespace lua
} // namespace game
