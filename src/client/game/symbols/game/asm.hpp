...
WEAK symbol<bool(const AIBody *aiBody, int32_t entityNum,
    ...
    G_ASM_AimLayerShouldBeActive{0x1415B1C50, 0x0, 0x14023F5B0};
WEAK symbol<void(int32_t entityNum)> G_ASM_AnimUpdated{0x1415B37A0, 0x0,
                                                       0x14023F6C0};
WEAK symbol<void(int32_t entityNum, LocalClientNum_t localClientNum,
                 vec3_t *headingVec)>
    G_ASM_GetAIHeadingVec{0x1415B6F60, 0x0, 0x14023FA30};
WEAK symbol<void(int32_t entityNum, LocalClientNum_t localClientNum,
                 vec3_t *moveVec)>
    G_ASM_GetAIMoveVec{0x1415B89F0, 0x0, 0x14023FA70};
WEAK symbol<void(int32_t entityNum, LocalClientNum_t localClientNum,
                 float *idleBlendRatio, const float idleBlendDropoff)>
    G_ASM_GetAIVelocityRatio{0x1415BA4E0, 0x0, 0x14023FB10};
WEAK symbol<bool(AIBody *aiBody, int32_t entityNum,
                 LocalClientNum_t localClientNum)>
    G_ASM_GetAimAnimations{0x1415BBFC0, 0x0, 0x14023FBC0};
WEAK symbol<int32_t(int32_t entityNum, LocalClientNum_t localClientNum)>
    G_ASM_GetEnemyEntNum{0x1415BC090, 0x0, 0x14023FC90};
WEAK symbol<bool(AIBody *aiBody, int32_t entityNum,
                 LocalClientNum_t localClientNum)>
    G_ASM_GetParametricAnimationGroup{0x1415BF540, 0x0, 0x14023FCE0};
WEAK symbol<void(int32_t entityNum, LocalClientNum_t localClientNum,
                 vec3_t *viewOrigin)>
    G_ASM_GetPlayerViewOrigin{0x1415BF620, 0x0, 0x14023FDC0};
WEAK symbol<bool(AIBody *aiBody, int32_t entityNum,
                 LocalClientNum_t localClientNum)>
    G_ASM_GetPrimaryDeltaAnimation{0x1415C1090, 0x0, 0x14023FDE0};
WEAK symbol<bool(AIBody *aiBody, int32_t entityNum,
...
WEAK symbol<asmStatus_t(AIBody *aiBody, int32_t entityNum)> G_ASM_PreUpdate{
    0x0, 0x0, 0x140240570};
WEAK symbol<void()> G_ASM_InitMocomps{0x1415C93D0, 0x0, 0x1402445D0};
WEAK symbol<int(AIBody *aiBody, int32_t entityNum,
                LocalClientNum_t localClientNum)>
    G_ASM_GetBurstCount{0x1415D3B70, 0x0, 0x140245090};
WEAK symbol<int(AIBody *aiBody, int32_t entityNum,
                LocalClientNum_t localClientNum)>
    G_ASM_GetFireInterval{0x1415D5610, 0x0, 0x1402450E0};
WEAK
    symbol<AIWeaponFireType(int32_t entityNum, LocalClientNum_t localClientNum)>
        G_ASM_GetFireMode{0x1415D70B0, 0x0, 0x140245130};
WEAK symbol<bool(AIBody *aiBody, int32_t entityNum,
                 LocalClientNum_t localClientNum)>
    G_ASM_GetShootAnimations{0x1415D8B20, 0x0, 0x140245150};
WEAK symbol<void(int32_t entityNum, bool shouldSet)> G_ASM_SetFiringFlag{
    0x1415D8C10, 0x0, 0x140245240};
WEAK symbol<bool(const AIBody *const aiBody, int32_t entityNum,
                 LocalClientNum_t localClientNum)>
    G_ASM_ShootLayerShouldBeActive{0x1415DA6F0, 0x0, 0x1402452D0};
} // namespace anim
} // namespace game
