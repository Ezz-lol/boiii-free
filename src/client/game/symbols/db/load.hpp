...
WEAK symbol<xasset::XAssetEntryPtr[15360]> g_copyInfo{0x0, 0x0, 0x14699D260};
WEAK symbol<uint32_t> g_copyInfoCount{0x0, 0x0, 0x146902028};
...
WEAK symbol<xasset::XAssetEntry *(xasset::XAssetEntry *entry,
    ...
    DB_LinkXAssetEntry{0x1414228E0, 0x1414228C0, 0x1401D7960};
...
WEAK symbol<bool(const char *path, DBFile f, xzone::XZoneBuffer *fileBuffer,
    ...
    DB_LoadXFile{0x1413EF6F0, 0x1413EF6D0, 0x1401A4920};
WEAK symbol<void(int zoneIndex, bool createDefault, qboolean suppressSync)>
    DB_UnloadXZone{0x141425A90, 0x141425A70, 0x1401DA6C0};
WEAK symbol<void()> DB_ReleaseXAssets{0x1414247E0, 0x1414247C0, 0x1401D9870};
WEAK symbol<void(xasset::MaterialTechniqueSetPtr *techniqueSet)>
    Load_MaterialTechniqueSetAsset{0x141426180, 0x0, 0x1401DB280};
// Actual name is unknown - this is a new function
WEAK symbol<void(xasset::MaterialTechniqueSetPtr techniqueSet)>
    R_Stream_ClearTechniqueSetShaders{0x0, 0x0, 0x14038EFC0};
} // namespace load
} // namespace db
} // namespace game
