...
WEAK symbol<void(const char *cmdName, xcommand_t function,
    ...
    Cmd_AddCommandInternal{0x1420E0510, 0x1420ECC90, 0x1404F8210};
// Reused _a lot_ in the engine for feature-gated function calls.
// There are a few dozen of these.
WEAK symbol<void()> Stub{0x0, 0x0, 0x1407DB4C0};
WEAK symbol<void(const char *cmdName, xcommand_t function,
                 cmd_function_s *allocedCmd)>
    Cmd_AddServerCommandInternal{0x1420E0580, 0x0, 0x1404F8280};
...
WEAK symbol<void(int localClientNum, ControllerIndex_t localControllerIndex,
                 ...
                 CmdArgs *args)>
    Cmd_TokenizeStringKernel{0x1420E25E0, 0x1420EED60, 0x1404FA300};
WEAK symbol<void()> Cmd_EndTokenizedString{0x1420E0750, 0x1420ECED0,
                                           0x1404F8420};
} // namespace cmd
} // namespace game
