...
WEAK symbol<uint64_t(int64_t size)> Hunk_AllocAlignInternal_32BAlignment{
    0x1422ABE40};
WEAK symbol<void()> Hunk_ClearData{0x1422ABFE0};
WEAK symbol<void()> Hunk_Clear{0x1422AC660, 0x14056BB50};
WEAK symbol<void(int64_t mark)> Hunk_ClearToMark{0x1422AC6C0};
...
WEAK symbol<void(HunkUser *allocationScheme)> Hunk_UserDestroy{0x1422D3920,
                                                               0x14057DC20};
