...
public:
  ...
  virtual bool InitGameServer(unsigned int unGameIP, unsigned short unGamePort,
                              unsigned short usQueryPort,
                              unsigned int unServerFlags, unsigned int nAppID,
  ...
  virtual int SendUserConnectAndAuthenticate(unsigned int unIPClient,
  ...
  virtual bool BUpdateUserData(steam_id steamIDUser, const char *pchPlayerName,
                               unsigned int uScore);
  virtual int GetAuthSessionTicket(void *pTicket, int cbMaxTicket,
