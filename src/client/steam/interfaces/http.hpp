...
public:
  ...
  virtual HTTPRequestHandle CreateHTTPRequest(uint32_t eHTTPRequestMethod,
                                              const char *pchAbsoluteURL);
  virtual bool SetHTTPRequestContextValue(HTTPRequestHandle hRequest,
                                          uint64_t ulContextValue);
  virtual bool SetHTTPRequestNetworkActivityTimeout(HTTPRequestHandle hRequest,
  ...
  virtual bool SetHTTPRequestGetOrPostParameter(HTTPRequestHandle hRequest,
  ...
  virtual bool SendHTTPRequestAndStreamResponse(HTTPRequestHandle hRequest,
                                                uint64_t *pCallHandle);
  ...
  virtual bool SetHTTPRequestRawPostBody(HTTPRequestHandle hRequest,
                                         ...
                                         uint8_t *pubBody, uint32_t unBodyLen);
  virtual HTTPCookieContainerHandle
  CreateCookieContainer(bool bAllowResponsesToModify);
  virtual bool
  ReleaseCookieContainer(HTTPCookieContainerHandle hCookieContainer);
  ...
  virtual bool
  SetHTTPRequestCookieContainer(HTTPRequestHandle hRequest,
  ...
  virtual bool
  SetHTTPRequestRequiresVerifiedCertificate(HTTPRequestHandle hRequest,
