...
HSteamPipe client::CreateSteamPipe() { return 1; }

bool client::BReleaseSteamPipe(HSteamPipe hSteamPipe) { return true; }

HSteamUser client::ConnectToGlobalUser(HSteamPipe hSteamPipe) { return 1; }
...
void *client::GetISteamUser(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                            const char *pchVersion) {
  return SteamUser();
}

void *client::GetISteamGameServer(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                                  const char *pchVersion) {
...
void *client::GetISteamFriends(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                               const char *pchVersion) {
  return SteamFriends();
}
...
void *client::GetISteamMatchmaking(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                                   const char *pchVersion) {
  return SteamMatchmaking();
}

void *client::GetISteamMatchmakingServers(HSteamUser hSteamUser,
...
void *client::GetISteamUserStats(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                                 const char *pchVersion) {
  return SteamUserStats();
}

void *client::GetISteamGameServerStats(HSteamUser hSteamuser,
                                       HSteamPipe hSteamPipe,
                                       const char *pchVersion) {
...
void *client::GetISteamApps(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                            const char *pchVersion) {
  return SteamApps();
}

void *client::GetISteamNetworking(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                                  const char *pchVersion) {
  return SteamNetworking();
}

void *client::GetISteamRemoteStorage(HSteamUser hSteamuser,
                                     HSteamPipe hSteamPipe,
                                     const char *pchVersion) {
  return SteamRemoteStorage();
}

void *client::GetISteamScreenshots(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                                   const char *pchVersion) {
...
uint32_t client::GetIPCCallCount() { return 0; }

void client::SetWarningMessageHook(void *pFunction) {}

bool client::BShutdownIfAllPipesClosed() { return true; }

void *client::GetISteamHTTP(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                            const char *pchVersion) {
  static http h;
  return &h;
}

void *client::GetISteamUnifiedMessages(HSteamUser hSteamuser,
                                       HSteamPipe hSteamPipe,
                                       const char *pchVersion) {
...
void *client::GetISteamController(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                                  const char *pchVersion) {
  static controller c;
  return &c;
}

void *client::GetISteamUGC(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                           const char *pchVersion) {
  static auto x = [] {
...
void *client::GetISteamAppList(HSteamUser hSteamUser, HSteamPipe hSteamPipe,
                               const char *pchVersion) {
  return get_dummy();
}

void *client::GetISteamMusic(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                             const char *pchVersion) {
  return get_dummy();
}

void *client::GetISteamMusicRemote(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                                   const char *pchVersion) {
  return get_dummy();
}

void *client::GetISteamHTMLSurface(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                                   const char *pchVersion) {
  return get_dummy();
}
...
void *client::GetISteamInventory(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                                 const char *pchVersion) {
  return get_dummy();
}

void *client::GetISteamVideo(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
                             const char *pchVersion) {
  return get_dummy();
}

void *client::GetISteamParentalSettings(HSteamUser hSteamuser,
                                        HSteamPipe hSteamPipe,
                                        const char *pchVersion) {
  return get_dummy();
}
