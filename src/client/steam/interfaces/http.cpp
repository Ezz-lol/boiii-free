...
namespace steam {
HTTPRequestHandle http::CreateHTTPRequest(uint32_t eHTTPRequestMethod,
...
bool http::DeferHTTPRequest(HTTPRequestHandle hRequest) { return false; }

bool http::PrioritizeHTTPRequest(HTTPRequestHandle hRequest) { return false; }
...
bool http::ReleaseHTTPRequest(HTTPRequestHandle hRequest) { return false; }
