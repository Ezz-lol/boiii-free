...
namespace steam {
uint64_t screenshots::WriteScreenshot(void *pubRGB, uint32_t cubRGB, int nWidth,
                                      int nHeight) {
  return 0;
}

uint64_t screenshots::AddScreenshotToLibrary(const char *pchFilename,
...
bool screenshots::TagPublishedFile(uint64_t hScreenshot,
