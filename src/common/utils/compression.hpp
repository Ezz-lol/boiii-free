...
write_file(const std::filesystem::path &output,
           const array<std::pair<const std::string, std::vector<uint8_t>>, N>
               &entries) {
...
inline void
write_file(const std::filesystem::path &output,
           const std::array<std::pair<const std::string, std::vector<uint8_t>>,
                            N> &entries) {
  return write_file(output, entries, N);
}
...
inline void
write_file(const std::filesystem::path &output,
           const std::vector<std::pair<const std::string, std::vector<uint8_t>>>
               &entries) {
...
inline void write_file(
  ...
  return write_file(
      output, std::vector<std::pair<const std::string, std::vector<uint8_t>>>(
